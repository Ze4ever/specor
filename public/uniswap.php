<?php
define('APP_CONTEXT', 'uniswap');
define('APP_DISPLAY_NAME', 'Uniswap Tracker');
...
require dirname(__DIR__) . '/app/uniswap/lib/actions.php';
...
require dirname(__DIR__) . '/app/uniswap/views/layout.php';
